...
parser.add_argument('--path_validating_data', type=str, default='../data/validating_data_dollars.jsonl', help='Path to validating data file')
parser.add_argument('--path_training_data', type=str, default='../data/training_data_dollars.jsonl', help='Path to training data file')
