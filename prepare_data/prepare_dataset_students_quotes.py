...
parser.add_argument('--path_validating_data', type=str, default='../data/validating_data_quotes.jsonl', help='Path to validating data file')
parser.add_argument('--path_training_data', type=str, default='../data/training_data_quotes.jsonl', help='Path to training data file')
...
if __name__ == '__main__':
    ...
    path = args.path_csv
    system_message = "Tu es un data scientist. On te présente des données concernant les étudiants inscrits au semestre d’automne, par faculté selon le sexe. Les valeurs statistiques sont entre quotes."
